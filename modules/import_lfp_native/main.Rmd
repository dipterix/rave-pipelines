...
```{rave obtain_subject_instance, language = "R", export = "subject"}
...
if(skip_validation) {
  ...
  if(!validation_result) {
    ...
    stop('The following issues found when importing subject ',
         sQuote(subject$subject_code), ' into project ', sQuote(subject$project_name),
...
```{rave check_import_signals, language = "R", export = "preprocess_info", cue = "always"}
